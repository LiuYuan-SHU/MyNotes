...
#include <memory>
#include "../../../Lession4/SystemSignalOverload/mypushbutton.h"
...
QT_MOC_LITERAL(13, 11), // "selfClicked"
QT_MOC_LITERAL(25, 0), // ""
QT_MOC_LITERAL(26, 4) // "test"

    },
    "MyPushButton\0selfClicked\0\0test"
};
...
void MyPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->selfClicked(); break;
        case 1: _t->selfClicked((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyPushButton::selfClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyPushButton::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyPushButton::selfClicked)) {
                *result = 1;
                return;
            }
...
, QtPrivate::TypeAndForceComplete<MyPushButton, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<const QString &, std::false_type>
...
// SIGNAL 0
void MyPushButton::selfClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyPushButton::selfClicked(const QString & _t1)
{
