...
end:"$",illegal:"\n"},o]}}})();hljs.registerLanguage("kotlin",e)})();/*! `crystal` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
keywords:a,contains:g}}})();hljs.registerLanguage("crystal",e)})();/*! `haskell` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{const n={
...
}),n,{begin:"->|<-"}]}}})();hljs.registerLanguage("haskell",e)})();/*! `rust` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("erlang-repl",e)})();/*! `objectivec` grammar compiled for Highlight.js 11.3.1 */
...
relevance:0}]}}})();hljs.registerLanguage("objectivec",e)})();/*! `puppet` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
relevance:0},n]}],relevance:0}]}}})();hljs.registerLanguage("puppet",e)})();/*! `vbnet` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
subLanguage:"clojure"}}]})})();hljs.registerLanguage("clojure-repl",e)})();/*! `vbscript` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
relevance:0}),e.C_NUMBER_MODE]}}})();hljs.registerLanguage("vbscript",e)})();/*! `coffeescript` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("coffeescript",e)})();/*! `lua` grammar compiled for Highlight.js 11.3.1 */
...
begin:"@[A-Za-z]+"}]}}})();hljs.registerLanguage("scala",e)})();/*! `vbscript-html` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>({name:"VBScript in HTML",
subLanguage:"xml",contains:[{begin:"<%",end:"%>",subLanguage:"vbscript"}]})})()
;hljs.registerLanguage("vbscript-html",e)})();/*! `typescript` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict"
;const e="[A-Za-z$_][0-9A-Za-z$_]*",n=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],a=["true","false","null","undefined","NaN","Infinity"],t=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],s=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],r=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],c=["arguments","this","super","console","window","document","localStorage","module","global"],i=[].concat(r,t,s)
...
;hljs.registerLanguage("typescript",e)})();/*! `erlang` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("erlang",e)})();/*! `java` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("java",e)})();/*! `groovy` grammar compiled for Highlight.js 11.3.1 */
